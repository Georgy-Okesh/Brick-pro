...
const internalLinks = [
  {
    ...
    alt: "Project image", // Updated alt text
  },
  {
    url: "#2",
    ...
    alt: "Recognition image", // Updated alt text
  },
  {
    url: "#3",
    ...
    alt: "Studio image", // Updated alt text
  },
  {
    url: "#4",
    component: <span>Contribution</span>,
    img: "https://images.unsplash.com/photo-1593697821028-7cc59cfd7399?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2100&q=80",
    alt: "Contribution image", // Updated alt text
  },
  {
    url: "#5",
    ...
    alt: "Career image", // Updated alt text
  },
];
